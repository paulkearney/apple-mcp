			...
			switch (name) {
				...
				case "mail": {
					...
					try {
						...
						switch (args.operation) {
							case "unread": {
								// Account scoping lives in the mail module now. The inline
								// AppleScript that used to live here ran
								// `messages of mb whose read status is false` over every mailbox
								// of the account, which pegs Mail.app and never returns.
